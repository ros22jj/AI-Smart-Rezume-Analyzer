...
// // // ─────────────────────────────────────────────────────────────
// // async function groqCall(messages, maxTokens = 3500) {
// //   const apiKey = process.env.GROQ_API_KEY || process.env.VITE_GROQ_API_KEY;
// //   if (!apiKey) throw new Error("GROQ_API_KEY is not set in server environment variables.");
...
// // // ─────────────────────────────────────────────────────────────
// // async function buildATSResume({ resumeText, jdText, githubUsername }) {
